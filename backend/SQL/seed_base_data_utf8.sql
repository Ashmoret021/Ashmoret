...
VALUES
    ('SkyMite-C7', '×¨×—×¤×Ÿ ×ž×¡×—×¨×™ ×§×œ', 1200, 2500, 3000000, '×"×¦×¤×" ×›×ž×•×ª×™×ª, ×—×ª×™×ž×" × ×ž×•×›×", ×ž×ª×�×™×� ×œ×©×—×™×§×ª ×§×©×‘ ×•×’×œ×�×™×�.', 15.0, 350000, 60.0, 800, 400),
    ('LoadBee-M2', '×¨×—×¤×Ÿ × ×©×™×�×ª ×ž×˜×¢×Ÿ ×§×œ', 650, 8000, 5200000, '× ×©×™×�×ª ×ž×˜×¢×Ÿ ×ž×•×’×‘×œ, ×�×™×•×� × ×§×•×"×ª×™ ×¢×œ ×�×ª×¨×™×� ×¨×’×™×©×™×�.', 15.0, 1000000, 60.0, 500, 150),
    ('Falcon-Long X4', '×¨×—×¤×Ÿ ×�×¨×•×šÖ¾×˜×•×•×— ×ž×�×•×œ×ª×¨', 320, 18000, 5760000, '×—×"×™×¨×" ×ž×¢×•×ž×§, ×"×•×¨×© ×’×™×œ×•×™ ×ž×•×§×"×� ×•×ª×¢×"×•×£ ×ž×™×™×¨×˜×™×� ×™×§×¨×™×�.', 50.0, 2000000, 60.0, 200, 120),
    ('NanoSwarm-Q9', '× ×—×™×œ ×¨×—×¤× ×™×� ×-×¢×™×¨×™×�', 2400, 900, 2160000, '×�×™×•×� ×¨×•×•×™ ×•×-×•×œ, ×ž×™×•×¢×" ×œ×©×—×™×§×ª ×ž×œ×�×™ ×•×œ×™×¦×™×¨×ª ×¨×™×‘×•×™ ×ž×˜×¨×•×ª.', 25.0, 150000, 60.0, 1000, 1400);
