...
export const EventLog: React.FC = () => {
  ...
  const logEntries = useMemo<LogEntry[]>(() => {
    ...
    const visible = history.filter(
      (e) => e.time <= state.simulationTime + 0.05,
    );
    // Sort newest first
    ...
    >
      <CardContent
        sx={{
          ...
          "&:last-child": { pb: isExpanded ? 1.5 : 1 },
        }}
      >
        {/* Header */}
        <Box
        ...
        <Collapse
          ...
          sx={{
            ...
            display: "flex",
            flexDirection: "column",
            "&.MuiCollapse-root": { flex: isExpanded ? 1 : "0 0 auto" },
            "& .MuiCollapse-wrapper": {
              minHeight: 0,
              display: "flex",
              flex: 1,
        ...
        >
          ...
          {/* Log Items List */}
          <Box sx={{ flex: 1, minHeight: 60, overflowY: "auto", pr: 0.5 }}>
