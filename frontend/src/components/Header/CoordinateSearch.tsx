  ...
  return (
    <div className="coord-search-container" ref={containerRef}>
      ...
      {hasMarker && onRemoveMarker && (
        <button
          type="button"
          className="header-action-btn coord-remove-btn"
          title="הסר סמן מהמפה"
        ...
        <div className="coord-search-dropdown">
          ...
          <form onSubmit={handleSubmit} className="coord-form">
            <div className="coord-input-group">
              ...
              />
              {latitude !== '' && !latValid && (
                <span className="coord-error-text">חייב להיות בין -90 ל-90</span>
              )}
            </div>
            ...
            <div className="coord-input-group">
              ...
              />
              {longitude !== '' && !lngValid && (
                <span className="coord-error-text">חייב להיות בין -180 ל-180</span>
              )}
            </div>
